// 카드 상세 뷰 — SSG 초기값(initial)을 즉시 렌더 후 Supabase 재조회로 최신화(수정분 즉시 반영)
'use client'

import ReactMarkdown from 'react-markdown'
import remarkGfm from 'remark-gfm'
import { useCardDetail } from '../../../lib/use-cards'
...
export function CardDetailView({
  ...
  const { data: card } = useCardDetail(platform, slug, initial)
  if (!card) return null
