...
- **CRITICAL: YouTube description fallback은 실제 transcript로 위장하지 않는다.** `transcriptSource`/`content_source`를 events와 vault에 기록하고, `transcript.md` 상단에 source를 남긴다.
...
- [docs/ADR.md](docs/ADR.md) — 핵심 결정 16개
